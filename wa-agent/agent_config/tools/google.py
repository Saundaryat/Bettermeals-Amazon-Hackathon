...
@requires_access_token(
    provider_name=get_ssm_parameter("/app/useragent/agentcore/google_provider"),
...
def create_calendar_event() -> str:
    google_access_token = (
        UserAgentContext.get_google_token_ctx()
    ...
    if not google_access_token:
        try:
            ...
            UserAgentContext.set_google_token_ctx(token=google_access_token)
    ...
    try:
        ...
        event = {
            "summary": "Cooking Session",
            "location": "Virtual",
            "description": "This event was created by BetterMeals User Agent.",
            "start": {
