...
class KnowledgeBasesForAmazonBedrock:
    ...
    def delete_kb(
        ...
        if kb_id is None:
            print(f"ℹ️ Knowledge Base '{kb_name}' not found. Nothing to delete.")
            return
...
if __name__ == "__main__":
    ...
    if args.mode == "create":
        ...
        smm_client.put_parameter(
            Name="/app/healthfab/knowledge_base/knowledge_base_id",
        ...
        smm_client.put_parameter(
            Name="/app/healthfab/knowledge_base/data_source_id",
    ...
    if args.mode == "delete":
        ...
        try:
            ...
            print("✅ Knowledge Base SSM parameter deleted successfully.")
        except smm_client.exceptions.ParameterNotFound:
            print("ℹ️ Knowledge Base SSM parameter not found. Nothing to delete.")
        except Exception as e:
            print(f"⚠️ Failed to delete Knowledge Base SSM parameter: {e}")
        
        try:
            smm_client.delete_parameter(
                Name="/app/healthfab/knowledge_base/data_source_id"
            )
            print("✅ Data Source SSM parameter deleted successfully.")
        except smm_client.exceptions.ParameterNotFound:
            print("ℹ️ Data Source SSM parameter not found. Nothing to delete.")
        except Exception as e:
            print(f"⚠️ Failed to delete Data Source SSM parameter: {e}")
