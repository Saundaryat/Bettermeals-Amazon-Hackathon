export const sharedPageStyles = {
  ...
  container: "min-h-[unset] sm:min-h-screen max-w-6xl mx-auto py-6 sm:py-3 flex flex-col px-4 sm:px-0 bg-white",
  ...
  header: "mb-8 mt-6 text-center lg:text-left",
  title: "text-3xl lg:text-4xl font-extrabold tracking-tight mb-2 text-gray-900 leading-tight",
  subtitle: "text-base lg:text-lg text-gray-500 font-medium max-w-xl lg:mx-0 italic mb-4 uppercase tracking-widest",
  loadingTitle: "text-2xl font-bold mb-1 text-gray-900",
  loadingSubtitle: "text-lg text-gray-500 italic mb-2",

  // Main content area styles - Mobile First
  mainContent: "rounded-2xl bg-white p-4 sm:p-5 shadow-zen flex-initial sm:flex-1 flex flex-col border border-black/10",
  ...
  button: `
    font-manrope text-base px-6 sm:px-7 py-4 rounded-xl font-bold uppercase tracking-wider
    bg-[#51754f] text-white hover:bg-[#51754f]/90
    shadow-lg shadow-[#51754f]/20 border border-[#51754f]
...
export const mealPlanStyles = {
  ...
  tag: "inline-flex items-center px-2 py-0.5 bg-gray-100 text-gray-600 rounded-full text-[10px] font-semibold border border-gray-200 transition-colors uppercase tracking-tight",
  activeTag: "inline-flex items-center px-2 py-0.5 bg-[#51754f]/10 text-[#51754f] rounded-full text-[10px] font-semibold border border-[#51754f]/20 uppercase tracking-tight",
